...
* (new in v1.1-beta-3) "ButtonFacade":http://wow.curse.com/downloads/wow-addons/details/buttonfacade.aspx support.

h2. Supported unit frames

* Blizzard target, focus and arena enemy frames,
* Nameplates, using "LibNameplate-1.0":http://wow.curse.com/downloads/wow-addons/details/libnameplate-1-0.aspx,
* "Shadowed Unit Frames":http://wow.curse.com/downloads/wow-addons/details/shadowed-unit-frames.aspx: target, focus and arena frames (ShadowedUF_Arena is no longer supported),
* "Gladius":http://wow.curse.com/downloads/wow-addons/details/gladius.aspx 2.0.x (arena unit frames),
